# random_toy_notebooks

A collection of toy notebooks for teaching my daughter python or relaxing.

- An [answer](notebooks/estimate_pi.ipynb) to a fun little interview prompt I saw on Reddit about estimating &pi; given a certain function.
